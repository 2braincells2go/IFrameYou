...
class IFrameYou
{
	...
	public function __construct($url, array $properties = array())
	{
        ...
        $this->addTemplate('vimeo', 		'http://player.vimeo.com/video/{path:0}', $properties);
        $this->addTemplate('dailymotion', 	'http://www.dailymotion.com/embed/video/{path:1}', $properties);
        $this->addTemplate('ted', 			'http://embed.ted.com/{path}', $properties);
        $this->addTemplate('break', 		'http://www.break.com/embed/{query:id}', $properties);
		$this->addTemplate('gamespot', 		'http://www.gamespot.com/videoembed/{query:id}', $properties);
		$this->addTemplate('twitch', 		'http://www.twitch.tv/widgets/live_embed_player.swf?channel={path:0}', $properties);
		$this->addTemplate('vine', 			'https://vine.co/v/{path:1}/embed/simple', $properties);
